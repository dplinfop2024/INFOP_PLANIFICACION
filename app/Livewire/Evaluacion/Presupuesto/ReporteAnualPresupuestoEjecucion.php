...
class ReporteAnualPresupuestoEjecucion extends Component
{
    ...
    {
        return view('livewire.evaluacion.presupuesto.reporte-anual-presupuesto-ejecucion', ['renglones' => $this->renglones]);
    }
}
