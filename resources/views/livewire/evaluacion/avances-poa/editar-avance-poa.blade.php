          ...
          <!-- Encabezado de la tabla -->
            ...
            <tbody class="text-center">
                ...
                <tr >
                    ...
                    <td></td>
                    <td></td>
                    <td rowspan="3" ><label for="exampleFormControlTextarea1" class="form-label"></label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </td>
                </tr>
                 <!-- Segunda  fila de datos -->
                ...
                <tr >
                    ...
                    <td rowspan="3" >
                        <label for="exampleFormControlTextarea1" class="form-label"></label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3">No  hubo solicitud de trabajo extra.</textarea>
                    </td>
                </tr>
                 <!-- Segunda  fila de datos -->
                <tr text-center ="text-center">
