<div>
    <style>
      ...
      <h1 class="centrarTexto">Lista Avance POA</h1>
           ...
           <thead>
            ...
            <tbody>
               <tr>
                   ...
                   <td>SI</td>
                   <td>SI</td>
                   <td><button type="button" class="btn btn-warning" href="{{route('poa.avances.ver.operativo')}}" wire:navigate>Detalles</button></td>
                 </tr>
            </tbody>
          </table>
       </div>
