...
<div style="background-color: #082338;">
    <div class="turquoise-bar">
        ...
        <div class="input-group mt-1">
            ...
            <button type="button" class="btn btn-light" style="border: 2px solid #e7e7e7" onclick="mostrarClave();"><img src="/images/oculto.png" id="foto2"
